...
Route::prefix('admin')->middleware('auth.administrators:administrators')->group(function() {
    ...
    Route::get('mail', [SendMailController::class, 'index'])->name('admin.email.index');
    Route::post('mail', [SendMailController::class, 'send'])->name('admin.email.send');
});
...
Route::middleware('auth')->group(function (){
    ...
    Route::post('purchase/address/update', [ProfileController::class, 'storeAddress']);
