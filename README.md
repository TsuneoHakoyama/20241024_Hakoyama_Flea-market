...
###### ログアウト：ログアウト機能。
###### 商品一覧：ログインの有無にかかわらず閲覧可能。ログインすることでマイページ、出品ページが利用可能となる。
###### 商品詳細：ログインの有無にかかわらず閲覧可能。ログインすることでマイページ、出品ページへアクセス可能となる。また、商品一覧ページでのお気に入り登録、コメントの追加および削除、商品購入が利用可能となる。自身が出品した商品は購入できない。プロフィールを未登録で商品購入ボタンを押すとプロフィール編集ページへと遷移する。
